...
export const SERVICES: ServiceItem[] = [
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    metaDescription:
      "Expert rebuilds and dyno testing of high-pressure hydraulic pumps (piston, gear, vane). OEM components and pressure calibration up to 350 Bar.",
    keywords:
      "high pressure pump repair, hydraulic pump service Hosur, piston pump rebuild Shoolagiri, gear pump repair Krishnagiri, RVS Hydraulics",
    description:
    ...
    customFields: [{ label: "Replacement Parts", value: "OEM Quality Parts" }],
    technicalDetails: [
  ...
  },
  {
    ...
    metaDescription:
      "Keep your operations running with pro hydraulic pump maintenance. Fluid contamination checks, filter cleaning, and bearing replacements in Shoolagiri.",
    keywords:
      "hydraulic pump maintenance, preventive pump service Hosur, pump filter replacement Shoolagiri, industrial pump maintenance",
    description:
  ...
  },
  {
    ...
    metaDescription:
      "Breathe new life into old, seized, or heavily worn hydraulic pumps. Precision parts fabrication, polishing, and cost-efficient OEM restorations.",
    keywords:
      "hydraulic pump restoration, seized pump repair Shoolagiri, old pump rebuild Hosur, custom parts fabrication",
    description:
      "Hydraulic Pump Restoration & Rebuilds is designed to salvage and revitalize older, rusted, or seized hydraulic pumps. Buying a brand-new high-capacity industrial pump can be extremely expensive and might involve long procurement lead times. Our restoration team specializes in stripping surface rust, honing corroded cylinder bores, building up worn surfaces via precision welding, fabricating custom internal components, and carefully fitting modern high-grade seals. We restore obsolete pumps to full operational standards.",
    customFields: [{ label: "Replacement Parts", value: "OEM Quality Parts" }],
    technicalDetails: [
  ...
  },
  {
    ...
    metaDescription:
      "Specialist servicing for variable displacement piston pumps & complex gear pumps. Calibrating pressure compensators for industrial systems.",
    keywords:
      "pump system servicing, variable displacement pump repair Hosur, compensator calibration Krishnagiri, gear pump servicing Shoolagiri",
    description:
      "Pump System Hydraulic Servicing focuses on variable-displacement piston pumps, complex dual-gear systems, and multi-stage pump modules. These systems utilize advanced internal controls like load-sensing compensators and horse-power limiters that require expert calibration. We calibrate compensator springs, test pilot valves, replace wear sleeves, and rebuild structural control pistons. This ensures smooth integration, steady flow response, and maximum fuel/energy efficiency.",
    customFields: [{ label: "Replacement Parts", value: "OEM Quality Parts" }],
    technicalDetails: [
  ...
  },
  {
    ...
    metaDescription:
      "Core pump repair services covering gear, vane, and piston pumps. Honest assessments, transparent pricing, and fast turnaround for mobile and ag pumps.",
    keywords:
      "hydraulic pump repair Shoolagiri, pump reconditioning Hosur, agricultural pump repair, mobile pump service Krishnagiri",
    description:
      "Hydraulic Pump Repair & Services represents our core pump servicing capabilities. We specialize in providing transparent, cost-efficient, and reliable repairs for gear, vane, and piston pumps used in agricultural, construction, and mobile machinery. From rebuilding gear chambers and replacing bearing sleeves to installing seal kits and balancing drive shafts, our team delivers high-quality craftsmanship, helping you extend the service life of your machinery.",
    customFields: [{ label: "Replacement Parts", value: "OEM Quality Parts" }],
    technicalDetails: [
  ...
  },
  {
    ...
    metaDescription:
      "Specialist repair of high-tonnage industrial hydraulic pumps. Massive torque tools, heavy-duty handling, and dyno-testing of continuous-flow pumps.",
    keywords:
      "industrial hydraulic pump repair Hosur, high tonnage pump rebuild Krishnagiri, heavy continuous flow pump service",
    description:
      "Industrial Hydraulic Pump Repair is our dedicated servicing program for large-scale, high-tonnage industrial hydraulic pumps. Rebuilding these massive components requires specialized heavy handling equipment, heavy-duty hydraulic pullers, and high-torque assembly tools. We dismantle massive pumps, inspect structural casings, remachining shaft interfaces, replace high-load bearings, and perform complete dynamic testing to ensure safe operation at extreme system pressures.",
    customFields: [{ label: "Replacement Parts", value: "OEM Quality Parts" }],
    technicalDetails: [
  ...
  },
  {
    ...
    metaDescription:
      "Professional hydraulic pump maintenance in Shoolagiri. Fluid health checks, vacuum leak tests, and bearing wear logging to extend pump lifespan.",
    keywords:
      "hydraulic pump maintenance Shoolagiri, pump fluid analysis Hosur, vacuum leak testing, preventative pump care",
    description:
      "Hydraulic Pump Maintenance is our systematic preventative servicing program designed to maximize the life of your hydraulic pumps. We inspect fluid cleanliness, replace pressure filters, check suction lines for vacuum leaks, inspect shaft alignments, and log operating parameters to track wear. By catching minor issues early, we help you avoid sudden mechanical failures, ensure smooth system pressure, and extend the lifespan of your hydraulic machinery.",
    customFields: [{ label: "Replacement Parts", value: "OEM Quality Parts" }],
    technicalDetails: [
