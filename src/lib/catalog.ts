...
export const CATALOG: CatalogItem[] = [
  {
    ...
    description: "Premium hydraulic pumps for industrial, mobile & agricultural applications. Repair & replacement available.",
    metaTitle: "Premium Hydraulic Pumps Shoolagiri | Piston, Vane & Gear Pumps",
    metaDescription: "Buy and service heavy-duty hydraulic pumps in Shoolagiri & Hosur. We stock high-performance gear, piston & vane pumps from leading global brands.",
    keywords: "hydraulic pumps Shoolagiri, hydraulic pumps Hosur, buy gear pump Krishnagiri, piston pump sales, vane pumps Bangalore, RVS Hydraulics",
  ...
  },
  {
    ...
    description: "Solenoid, manual and proportional valves from trusted brands for every hydraulic circuit.",
    metaTitle: "Hydraulic Valves Sales & Service Hosur | RVS Hydraulics",
    metaDescription: "Complete catalog of industrial hydraulic valves in Hosur. We supply directional control solenoid valves, pressure relief valves & manual spools.",
    keywords: "hydraulic valves Hosur, solenoid valves Shoolagiri, pressure relief valve Krishnagiri, proportional valves Bangalore, RVS Hydraulics",
    ...
    technicalSpecs: [
      { label: "Valve Categories", value: "Directional, Pressure Relief, Flow Control, Check, Proportional" },
      { label: "Actuation Types", value: "Solenoid (AC/DC), Manual Lever, Pilot Air, Hydraulic Pilot" },
  ...
  },
  {
    ...
    description: "Custom hose pipe assemblies with brass / steel fittings — crimped to spec on demand.",
    metaTitle: "High-Pressure Hydraulic Hose Crimping Shoolagiri | Custom Assemblies",
    metaDescription: "Need a custom hydraulic hose crimped immediately? We specialize in single, double, and four-spiral steel wire reinforced hose assemblies in Shoolagiri.",
    keywords: "hydraulic hose pipes Shoolagiri, custom hose crimping Hosur, high pressure hoses Krishnagiri, steel braided hose pipes, RVS Hydraulics",
    ...
    technicalSpecs: [
      ...
      { label: "End Fittings Available", value: "BSP, NPT, JIC, Metric, Flange (Straight, 45°, 90°)" },
      { label: "Outer Cover Material", value: "Ozone-resistant, abrasion-resistant synthetic rubber" }
    ],
    image: hoses,
    faqs: [
      {
  ...
  },
  {
    ...
    description: "Wide range of hydraulic fittings, adapters and connectors in brass and stainless steel.",
    metaTitle: "Premium Hydraulic Fittings & Adapters Hosur | RVS Hydraulics",
    metaDescription: "Massive selection of industrial-grade hydraulic fittings, steel adapters, 90-degree elbow unions, and metric-BSP connectors in Hosur & Shoolagiri.",
    keywords: "hydraulic fittings Hosur, hydraulic adapters Shoolagiri, steel pipe fittings Krishnagiri, BSP JIC metric connectors, RVS Hydraulics",
    ...
    technicalSpecs: [
      { label: "Materials Standard", value: "Carbon Steel (Zinc Plated), Stainless Steel 316, Brass" },
      { label: "Thread Standards", value: "BSP, JIC (37° Flare), Metric (DIN 2353), NPT, ORFS" },
      { label: "Working Pressure Capacity", value: "Light Duty (L) up to 250 Bar, Heavy Duty (S) up to 630 Bar" },
      { label: "Fittings Styles", value: "Straight, 45° Elbow, 90° Elbow, Equal Tee, Reducing Unions" },
      { label: "Sealing Mechanism", value: "Metal-to-metal flare, O-ring face seal, bite-type compression rings" }
    ],
    image: fittings,
    faqs: [
      {
  ...
  },
  {
    ...
    metaDescription: "Genuine hydraulic seal kits in Krishnagiri & Shoolagiri. We stock polyurethane piston seals, rod wipers & Nitrile O-rings for cylinders and pumps.",
    keywords: "hydraulic seal kits Krishnagiri, hydraulic O-rings Shoolagiri, cylinder seals Hosur, Parker cylinder seal kits, RVS Hydraulics",
    ...
    technicalSpecs: [
      { label: "Seal Components", value: "U-cups, Piston rings, Rod wipers, Guide strips, Backup rings, O-rings" },
      { label: "Material Options", value: "Polyurethane (PU), Viton (FKM), Nitrile Rubber (NBR), PTFE (Teflon)" },
  ...
  },
  {
    ...
    description: "Complete range of hydraulic accessories to keep your system running clean and reliable.",
    metaTitle: "Hydraulic Accessories Shoolagiri | Gauges, Filters & Manifolds",
    metaDescription: "Shop high-performance hydraulic accessories in Shoolagiri & Hosur. We stock pressure gauges, suction strainers, offline filter rigs, and oil breathers.",
    keywords: "hydraulic accessories Shoolagiri, hydraulic gauges Hosur, return line filters, oil level indicators Krishnagiri, RVS Hydraulics",
    ...
    technicalSpecs: [
      { label: "Accessories Stocked", value: "Suction strainers, Return line filters, Breathers, Level gauges, Pressure gauges" },
      ...
      { label: "Manifold Materials", value: "High-strength extruded aluminum or carbon steel blocks" }
    ],
    image: accessories,
    faqs: [
      {
  ...
  },
  {
    ...
    description: "Design, supply and servicing of custom hydraulic power packs for any tonnage and duty cycle.",
    metaTitle: "Custom Hydraulic Power Pack Sales & Service | Hosur & Krishnagiri",
    metaDescription: "Specialist design, assembly and servicing of industrial hydraulic power packs. Custom reservoir systems, solenoid banks, and certified motor-pump setups.",
    keywords: "hydraulic power packs Hosur, custom power unit sales Krishnagiri, hydraulic power pack service Shoolagiri, RVS Hydraulics",
    ...
    technicalSpecs: [
      ...
      { label: "Control Integration", value: "Solenoid valve blocks, Manual spools, Proportional cards, PLCs" },
      { label: "Cooling Systems", value: "Air-cooled oil heat exchangers or water-cooled shell-tube systems" },
      { label: "Applications Support", value: "Scrap baling presses, industrial molding machines, garage lifts" }
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    description: "Manufacturing, repair and reconditioning of hydraulic cylinders of every bore and stroke.",
    metaTitle: "Hydraulic Cylinder Manufacturing & Rebuilding Shoolagiri | RVS",
    metaDescription: "Industrial-grade hydraulic cylinder manufacturing and reconditioning. Single-acting, double-acting & telescopic designs built to precise metric standards.",
    keywords: "hydraulic cylinder manufacturing Shoolagiri, hydraulic cylinder rebuilding Hosur, custom cylinder fabrication Krishnagiri, RVS Hydraulics",
    ...
    technicalSpecs: [
      ...
      { label: "Mounting Configurations", value: "Clevis, Trunnion, Flange, Foot mount, Spherical eye" },
      { label: "Working Pressure rating", value: "Standard 210 Bar, Heavy Duty up to 350 Bar" },
      { label: "Piston Rod options", value: "Induction-hardened C45 steel, Hard chrome plated (min 30 microns)" }
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    description: "High-pressure manual hydraulic pumps for precision lifting, testing, and pressing.",
    metaTitle: "High-Pressure Manual Hydraulic Hand Pumps | Hosur & Shoolagiri",
    metaDescription: "Heavy-duty manual hydraulic hand pumps for precision lifting, maintenance, and pressure testing. High-volume dual-stage pumps from RVS Hydraulics.",
    keywords: "hydraulic hand pumps Hosur, manual hydraulic pumps Shoolagiri, high pressure hand pumps, RVS Hydraulics",
    ...
    technicalSpecs: [
      ...
      { label: "Oil Reservoir Volume", value: "0.5 Liters to 3 Liters (Steel or composite casing)" },
  ...
  },
  {
    ...
    description: "Machine-green, heavy-duty industrial hydraulic cylinders with robust clevis mounts for maximum load stability.",
    metaTitle: "Heavy-Duty Clevis Mount Cylinders Hosur | RVS Hydraulics",
    metaDescription: "Buy industrial-grade machine-green clevis hydraulic cylinders in Hosur & Krishnagiri. Designed for heavy load stability, agricultural & earthmoving use.",
    keywords: "clevis hydraulic cylinders Hosur, clevis mount cylinder, heavy duty agricultural cylinder Krishnagiri, RVS Hydraulics",
    ...
    technicalSpecs: [
      ...
      { label: "Working Pressure Limit", value: "Continuous 250 Bar (Heavy peak spikes up to 320 Bar)" },
      { label: "Finishing Paint", value: "Anti-corrosive machine-green industrial polyurethane coat" }
    ],
  ...
  },
  {
    ...
    technicalSpecs: [
      ...
      { label: "Applications", value: "Marine steering systems, cleanrooms, sparking hazard zones" }
    ],
  ...
  },
  {
    ...
    description: "High-reliability single-phase hydraulic power packs designed for seamless, continuous toll gate barrier operation.",
    metaTitle: "Toll Gate Single Phase Hydraulic Power Packs | Hosur",
    metaDescription: "Compact 1-phase hydraulic power packs designed for toll gate barrier gates in Hosur & Krishnagiri. Extreme cycle reliability, rapid rise speeds.",
    keywords: "toll gate power pack Hosur, single phase hydraulic unit Krishnagiri, toll gate barrier hydraulics, 1-phase hydraulic power pack",
    ...
    technicalSpecs: [
      ...
      { label: "Control Valves", value: "Fast-acting 12V/24V DC solenoid valve with manual override" },
  ...
  },
  {
    ...
    description: "Durable hydraulic lifting systems specifically designed for two-wheeler garages and service stations.",
    metaTitle: "Two-Wheeler Hydraulic Garage Lifts Hosur | RVS Hydraulics",
    metaDescription: "Buy robust hydraulic bike lifting tables & scissor lifts for garages in Hosur & Shoolagiri. Heavy steel platforms, safety locks, 500kg lifting load.",
    keywords: "two wheeler bike lifting lift Hosur, garage bike lifting system Shoolagiri, hydraulic bike lift Krishnagiri, motorcycle lifting table",
    longDescription: "Transform workshop productivity with our heavy-duty Two Wheeler Garage Bike Lifting Systems. Traditional servicing requires mechanics to work in uncomfortable bent positions, which causes fatigue and slows down service cycles. Our professional hydraulic scissor and platform lifting tables raise motorcycles to comfortable heights. Engineered with heavy-duty structural steel plates, a robust foot-pedal pump (or optional single-phase electric unit), and multi-position safety locking slots, these lifts handle cruisers and sportbikes up to 500kg, keeping workshops safe and highly efficient.",
    technicalSpecs: [
      ...
      { label: "Actuation Options", value: "Manual hydraulic foot-pedal or electro-hydraulic 1-Phase motor" },
      { label: "Safety Systems", value: "Mechanical safety lock bars, wheel-clamp lock, anti-skid surface" }
    ],
